...
import { addOrderToCartAction, getCartItemsFromLocalStorage } from "../../../redux/slices/cart/cartSlice";
const product = {
  name: "Basic Tee",
  price: "$35",
  href: "#",
...
export default function Product() {
  ...
  // get data from store
  const {error, loading, product:{product}} = useSelector((state) => state?.products)
  // console.log(product);
  ...
  const addToCartHandler = () => {
    ...
    // checked if color/size is selected
    if (selectedColor === "") {
      return Swal.fire({
        icon: "error",
        title: "Ooops...!",
    ...
    return dispatch(getCartItemsFromLocalStorage())
