...
import { changeOrderItemQty, getCartItemsFromLocalStorage, removeOrderItemQty } from "../../../redux/slices/cart/cartSlice";
import { fetchCouponAction } from "../../../redux/slices/coupon/couponsSlice";
...
export default function ShoppingCart() {
  ...
  // price of the product - (price of the product * discount/100)
                    ...
                    <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                      ...
                      <div className="mt-4 sm:mt-0 sm:pr-9">
                        ...
                        <select
                          ...
                          //   )
                          // }
                          // onChange={() => dispatch(changeOrderItemQty("ffff", 2))}
                          // onChange={(e) => dispatch(changeOrderItemQty({ 
                          //   productId: product?._id, 
                          //   qty:  Number(e.target.value),
                          // })) }
                          // updating qty and price to refresh by default
                          onChange={(e) => changeOrderItemQtyHandler(
                            product?._id,
                            e.target.value
                          )}
                          ...
                          {/* {[...Array(product?.qytLeft).keys()].map((x) =>{
                            return (
                          ...
                          {Number.isFinite(product?.qtyLeft) && product?.qtyLeft > 0 ? (
                            [...Array(product?.qtyLeft).keys()].map((x) => (
                              <option key={x} value={x + 1}>
                                {x + 1}
                              </option>
                            ...
                            <option value={1}>1</option> // fallback if qtyLeft is invalid
                          )}
